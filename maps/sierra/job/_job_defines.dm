...
#define HUMAN_ONLY_JOBS /datum/job/hos, /datum/job/hop, /datum/job/chief_engineer, /datum/job/rd, /datum/job/cmo, /datum/job/iaa, /datum/job/iso, /datum/job/psychiatrist, /datum/job/captain, /datum/job/exploration_leader, /datum/job/explorer, /datum/job/explorer_medic, /datum/job/explorer_engineer
...
#define SKRELL_BLACKLISTED_JOBS /datum/job/hos, /datum/job/hop, /datum/job/iaa, /datum/job/iso, /datum/job/psychiatrist, /datum/job/captain, /datum/job/exploration_leader, /datum/job/explorer, /datum/job/explorer_medic, /datum/job/explorer_engineer
