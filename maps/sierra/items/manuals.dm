...
/obj/item/book/manual/nt_sop
	name = "SEAF Standard Operating Procedures"
...
/obj/item/folder/envelope/preset/blanks
	desc = "A thick envelope. The Super Earth Central Government crest is stamped in the corner, along with \"TOP SECRET - FOR RESEARCH DIRECTOR'S EYES ONLY\"."
...
/obj/item/paper/sierra/blanks
	...
	<b>ОТ:</b> Swadian Barwuds, Руководитель Исследований и Разработок, SES Will of the People<br>
	<b>КОМУ:</b> Директору Исследований SES Sierra Democratica<br>
	<b>А ТАКЖЕ:</b> Командующему Офицеру SES Sierra Democratica, Офицеру по Демократии на борту SES Sierra Democratica<br>
	...
	<i>This paper has been stamped with the stamp of SEAF Sectorial Command.</i>
	"}

/obj/item/folder/envelope/preset/captain
	desc = "A thick envelope. The Super Earth Central Government crest is stamped in the corner, along with \"TOP SECRET - FOR COMMANDING OFFICER'S EYES ONLY\"."
...
/obj/item/folder/envelope/preset/captain/Initialize()
	...
	<b>ОТ:</b> George Hammond, Череп-Адмирал, SES Will of the People<br>
	<b>КОМУ:</b> Командующему Офицеру SES Sierra Democratica<br>
	<b>ТЕМА:</b> Задачи миссии (протокол \"Альфа\")<br>
	<hr>
	Командующий Офицер,<br>
	...
	<li>[generate_system_name()]</li>
	<li>[generate_system_name()]</li>
	<li>Callypso System</li>
	<br>
	Приоритетной целью является обеспечение безопасности расположенных в пределах района патрулирования колоний Супер-Земли.<br>
	По мере развития ситуации на фронте вам могут быть направлены новые директивы, а также передаваться сигналы бедствия от других колоний, оказывающихся под атакой вне вашего района патрулирования. Не игнорируйте их.<br>
	Слава Супер-Земле!<br>

	<font face="Verdana" color=black><font face="Times New Roman"><i>George Hammond</i></font></font></tt><br><hr>
	<i>This paper has been stamped with the stamp of SEAF Sectorial Command.</i>
	"}
...
/obj/item/folder/envelope/preset/rep
	desc = "A thick envelope. The Super Earth Central Government crest is stamped in the corner, along with \"TOP SECRET - FOR MINISTRY OF TRUTH PERSONNEL ONLY\"."
...
/obj/item/paper/sierra/umbra
	...
	<b>ОТ:</b> George Hammond, Череп-Адмирал, SES Will of the People<br>
	<b>КОМУ:</b> Командующему Офицеру SES Sierra Democratica<br>
	<b>А ТАКЖЕ:</b> Офицеру по Демократии на борту SES Sierra Democratica<br>
	<b>ТЕМА:</b> Протокол УМБРА<br>
	<hr>
	В данном сообщении приводится описание протокола под кодовым наименованием \"Умбра\" - небольшого, но значимого дополнения к стандартным процедурам, необходимого для избежания утечек информации, критически важной для дальнейшего существования Супер-Земли. В отличии от остальных СОП, информация о существовании данного протокола не должна оглашаться экипажу корабля.<br>
	Данная процедура может быть инициирована исключительно по распоряжению Секторального Командования ВССЗ. Сообщение, которое вы получите, может не иметь стандартной печати или подписей, но у вас не должно возникнуть проблем с подтверждением легетимности данного распоряжения. Мы надеемся.<br>
	...
	<li>Информация об экспедиционных находках, которые представляют угрозу человечеству в целом, должна быть отправлена СК ВССЗ под кодовым именем \"Умбра\". Мы надеемся, что у вас не возникнет проблемы с определением того, какая именно информация подпадает под данное определение.</li>
	<li>Конфидециальность данной информации имеет наивысший приоритет. Только Капитан и Агенты внутренних дел могут иметь полный, неограниченный доступ к собранным данным; Главы отделов и члены СБ могут быть уведомлены о ситуации лишь в той мере, в которой это необходимо для исполнения протокола \"Умбра\". Все остальные лица, которые так или иначе получили доступ к релевантной информации, должны быть помещены под надзор СБ до окончательного выполнения процедуры.</li>
	...
	<li>Вне зависимости от прогресса вашей миссии в рамках протокола \"Альфа\", вы должны немедленно совершить прыжок в Солнечную систему и прибыть в доки Центрального Командования ВССЗ. Дальнейшие инструкции будут переданы вам по прибытию. Не совершайте остановок по пути без критической необходимости.</li>
	<li>Исполнение данного протокола имеет приоритет над всеми иными процедурами, включая Космический Закон и ОПРС.</li>
	...
	<i>Всего наилучшего, George.</i></tt><br><hr>
	<i>This paper has been stamped with the stamp of SEAF Sectorial Command.</i>
	"}
...
/obj/item/folder/envelope/preset/nuke
	desc = "A thick envelope. The Super Earth Central Government crest is stamped in the corner, along with \"TOP SECRET - DELTA PROTOCOLS\"."
...
/obj/item/paper/sierra/nuke
	...
	<b>ОТ:</b> George Hammond, Череп-Адмирал, SES Will of the People<br>
	<b>КОМУ:</b> Командующему Офицеру SES Sierra Democratica<br>
	<b>А ТАКЖЕ:</b> Главам отделов SES Sierra Democratica, Офицеру по Демократии на борту SES Sierra Democratica<br>
	...
	Согласно выводам аналитического отдела, текущая миссия КСЗ \"Сьерра Демократика\" имеет ненулевую вероятность привести к штурму и захвату корабля агентами тирании. В целях предотвращения получения анти-демократическими элемантами подробной информации об операциях ВССЗ, на борту судна было размещено ядерное взрывное устройство мощностью 500 килотонн в тротилловом эквиваленте.<br>
	...
	Размещенная на борту вашего судна ядерная боеголовка хранится в защищённом отсеке, расположенном в носовой части первой палубы судна. Шлюз доступа данного отсека помечен как <b>\"Vault\"</b>; в случае возникновения вопросов о назначении помещения от неавторизованных членов экипажа, им следует сообщить, что в данном хранилище находятся физические копии всех исследовательских данных, собранных судном за время его операций, на бумажных носителях. Аналитический отдел убежден, что данная легенда предотвратит излишний интерес к хранилищу со стороны рядовых членов экипажа КСЗ \"Сьерра Демократика\".<br>
	Правом на инициацию протокола \"Дельта\" наделён исключительно командующий офицер судна; в случае, если командующий офицер недоступен или недееспособен, необходимо запросить подтверждение Секторального Командования посредством любой доступной защищённой системы связи.<br>
