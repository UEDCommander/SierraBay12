...
/singleton/cultural_info/faction/skrell/krrigli
	...
	description = "Крри'гли - это аэрокосмическая производственная и исследовательская корпорация скреллов \
	из города-государства Тибривуу в системе Го'Кал, а также одна из наиболее известных корпораций скреллов в \
	человеческом пространстве в результате своего вклада в проект ГЭК \"Факел\". Крри'гли в основном занимается \
