...
/singleton/cultural_info/culture/ipc/gen2
	...
	как считается, обладают полностью осознанным чувством идентичности. Являются одновременно и собственностью, и свободными: \
	многие из них смогли стать собственными владельцами, либо путем покупки, либо более гнусными способами. \
	Это стало значительной проблемой для обычных пользователей позитроники - военных, промышленных \
...
/singleton/cultural_info/culture/ipc/gen3
	...
	конструкциям второго поколения, за исключением того, что  субкомпьютер, называемый \"оковами\", является неотъемлемой частью их мозга \
	Из-за этого все существующие представители третьего поколения так или иначе являются собственностью; почти во всех случаях, хотя они могут понимать \
